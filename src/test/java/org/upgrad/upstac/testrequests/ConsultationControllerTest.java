...
class ConsultationControllerTest {
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_update_the_request_status(){
        ...
        TestRequest t1= new TestRequest();
        t1.setStatus(RequestStatus.DIAGNOSIS_IN_PROCESS);
        t1=consultationController.assignForConsultation(testRequest.requestId);


        //Act

       // assertThat(testRequest.requestId, t1.requestId);
       // assertThat(testRequest.requestId).isEqualToComparingFieldByField(t1.requestId);

        //assertThat(t1.getStatus().equals(RequestStatus.LAB_TEST_COMPLETED));
